...
public class Constants {
  ...
  public static final String MANIFEST_EXTRACTION_LOC = "/tmp/rhi-manifest";
  public static final String MANIFEST_UPSTREAM_CONSUMER_LOC =
    MANIFEST_EXTRACTION_LOC + "/export/upstream_consumer";
  public static final String MANIFEST_CONSUMER_EXPORT_ZIP =
    MANIFEST_EXTRACTION_LOC + "/consumer_export.zip";
